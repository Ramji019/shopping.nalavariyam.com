    ...
    <div class="offcanvas-body p-0">
      ...
      @if(Auth::user())
        ...
        <ul class="sidenav-nav ps-0">
          ...
          <li>
            <a href="{{ url('/user/add_product') }}"><i class="bi bi-plus"></i>Sell property</a>
          </li> 
		  <li>
            <a href="{{ url('/user/wish') }}"><i class="bi bi-heart"></i>Wish List</a>
          </li>
          <li>
            <a href="{{ url('/user/sold_products') }}"><i class="bi bi-layers"></i>Sold property</a>
          </li> --}}
          <li>
          ...
          <li>
            <a href="{{ url('/userlogout') }}"><i class="bi bi-box-arrow-right"></i>Log Out</a>
          </li>
		</ul>
	  </li>
	</ul>
