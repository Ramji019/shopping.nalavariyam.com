    ...
    <div class="page-content-wrapper py-3">
        <div class="container">
            <div class="card-header"> 
                <h5 class="mb-1 text-center">Explore ThirdCategory</h5>
            </div>
            <hr>
                            ...
                            <div class="col-6 col-sm-4 col-lg-3 product_div">
                                <div class="card single-product-card">
                                    <div class="card-body p-1">
                                        <a class="product-thumbnail d-block" href="{{ url('/category', $third->id) }}">
                                            <div class="product-thumbnail d-block">
                                                <div
                                                    style="width: 150px; height: 100px; background-image: url('{{ URL::to('/') }}/uploads/category/{{ $third->photo }}'); background-size: contain; background-repeat: no-repeat; background-position: 50% 50%;">
                                                </div>
                                        </div>
                                        </a>

                                   <center> <a class="product-title d-block text-truncate"
                                        href="{{ url('/category', $third->id) }}">{{ $third->category_name }}</a></center>
                                </div>
                            </div>
                        </div>
                    @endforeach
