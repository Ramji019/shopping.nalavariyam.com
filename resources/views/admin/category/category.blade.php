            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                 ...
                 @foreach($category as $cate)
                    ...
                    <td>
             <a onclick='edit_category("{{ $cate->id }}","{{ $cate->category_name }}","{{ $cate->status }}")'
          href="#" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>Edit</a>

          <a href="{{ url('/admin/subcategory', $cate->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-arrow-circle-right"></i> Sub Category</a>
