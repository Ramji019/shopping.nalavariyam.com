        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ url('/addsubcategory') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-12">
                ...
                <table id="example2" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> 
                                <a href="{{ url('/admin/thirdlevelcategory', $cat->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-arrow-circle-right"></i> Third Category</a>
                              ...
                              {{--   <a onclick="return confirm('Do you want to Confirm delete operation?')"
                                    href="{{ url('/deletesubcategory', $cat->id) }}" class="btn btn-danger btn-sm"><i
...
@push('page_scripts')
<script>
function edit_subcategory(id, subcategory_name, status, ) {
    $("#editsubcategoryname").val(subcategory_name);
