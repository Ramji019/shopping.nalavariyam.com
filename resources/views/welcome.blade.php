                ...
                <div class="property-listing property-2">
                    <div class="listing-img-wrapper">
                        <div class="list-img-slide">
                            <div class="click">
                                <div><a href="{{ url('/subcategory', $categorylist->id) }}"><img
                                    src="{{ URL::to('/') }}/uploads/category/{{ $categorylist->photo }}"
                        ...
                        <div class="listing-detail-wrapper">
                            <div class="listing-short-detail-wrap">
                                <div class="listing-short-detail">
                                    <a href="{{ url('/subcategory', $categorylist->id) }}">
                                        <center><h4 class="listing-name">{{ $categorylist->category_name }}
                                        </a></h4></center>
                                    </div>
